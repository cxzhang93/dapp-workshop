...
run_lock() {
  ...
  PIDS+=("$!")
  wait_rpc
  echo "MetaMask: connect to Localhost 8545 (chain ID 31337)."
  echo "Import disposable account 0 with private key:"
  echo "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80"
  (cd "$ROOT/lock/webapp" && BROWSER=none HOST=127.0.0.1 PORT=3000 npm start) &
  PIDS+=("$!")
